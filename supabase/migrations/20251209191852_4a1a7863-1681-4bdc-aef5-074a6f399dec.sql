-- Add bathroom accessories to the seed function
...
-- Insert new accessory trade buckets for all existing contractors
INSERT INTO public.trade_buckets_config (contractor_id, trade_name, display_name, unit, ic_per_unit, margin_percent, category, description)
SELECT 
  c.id,
  v.trade_name,
...
CROSS JOIN (VALUES
  ('electrical_led_mirror', 'Electrical - LED Mirror', 'ea', 150, 0.40, 'Electrical', 'LED/backlit mirror wiring and install'),
  ('electrical_exhaust_fan', 'Electrical - Exhaust Fan', 'ea', 175, 0.38, 'Electrical', 'Bathroom exhaust fan installation'),
  ('accessory_towel_bar', 'Towel Bar Install', 'ea', 35, 0.45, 'Accessories', 'Towel bar mounting and installation'),
  ('accessory_towel_ring', 'Towel Ring Install', 'ea', 30, 0.45, 'Accessories', 'Towel ring mounting and installation'),
  ('accessory_tp_holder', 'TP Holder Install', 'ea', 25, 0.45, 'Accessories', 'Toilet paper holder installation'),
  ('accessory_robe_hook', 'Robe Hook Install', 'ea', 25, 0.45, 'Accessories', 'Robe hook mounting and installation'),
  ('accessory_grab_bar', 'Grab Bar Install', 'ea', 85, 0.40, 'Accessories', 'ADA grab bar with structural mounting'),
  ('accessory_shower_shelf', 'Shower Shelf Install', 'ea', 45, 0.45, 'Accessories', 'Shower shelf or corner caddy install'),
  ('accessory_mirror', 'Mirror Install', 'ea', 75, 0.40, 'Accessories', 'Standard vanity mirror mounting'),
  ('accessory_medicine_cabinet', 'Medicine Cabinet Install', 'ea', 125, 0.40, 'Accessories', 'Recessed or surface medicine cabinet'),
  ('accessory_package', 'Accessories Package', 'ea', 150, 0.45, 'Accessories', 'Full accessory package (towel bar, TP holder, robe hooks)')
) AS v(trade_name, display_name, unit, ic_per_unit, margin_percent, category, description)
ON CONFLICT (contractor_id, trade_name) DO NOTHING;